...
const HeroSection = ({ onNavigate }) => {
    const currentPhrase = useTypingEffect(PHRASES);
        ...
        <div className="flex items-center justify-center min-h-screen text-gray-800 dark:text-white pt-20 pb-28">
            <div className="max-w-7xl w-full mx-auto px-6 sm:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="text-center md:text-left z-10">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-lg mx-auto md:mx-0 text-sm sm:text-base leading-relaxed">
                        Soy <strong className="text-gray-900 dark:text-white font-semibold">Saúl Rondón E.</strong>, Desarrollador Web Full Stack. Me especializo en transformar ideas complejas en aplicaciones robustas, combinando arquitectura moderna, diseño funcional y alto rendimiento.
                    </p>
