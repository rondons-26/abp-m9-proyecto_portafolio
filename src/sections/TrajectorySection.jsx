...
const TrajectorySection = () => {
  return (
    <section className="min-h-screen text-gray-800 dark:text-white pt-20 pb-28 flex items-center justify-center">
      {/* Contenedor simétrico con Header y Hero */}
      <div className="max-w-7xl w-full mx-auto px-6 sm:px-12">
        ...
        {/* Grid Estructurado Bento Style */}
        <div className="grid lg:grid-cols-12 gap-6 items-stretch">
          
          {/* Experiencia Laboral con Timeline distribuido uniformemente */}
          <div className="lg:col-span-7 bg-white dark:bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-sm flex flex-col justify-between">
            ...
            {/* Contenedor flexible con mayor separación vertical */}
              ...
              <div className="relative border-l-2 border-blue-500/30 dark:border-blue-500/20 ml-3 space-y-8">
                {experiences.map((exp) => (
                  <div key={exp.id} className="relative pl-6 sm:pl-8 group">
                    {/* Punto conector en la línea de tiempo */}
          ...
          {/* Columna Derecha: Formación + Habilidades */}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {skills.technical.map((skill) => (
                      <span key={skill} className="bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900 text-[11px] font-semibold px-2.5 py-1 rounded-lg">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {skills.soft.map((skill) => (
                      <span key={skill} className="bg-gray-100 dark:bg-gray-700/60 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600 text-[11px] font-medium px-2.5 py-1 rounded-lg">
                        {skill}
                      </span>
                    ))}
                  </div>
