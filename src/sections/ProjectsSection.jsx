                            ...
                            <div 
                                ...
                                <div 
                                    ...
                                    <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 bg-white dark:bg-gray-800 rounded-2xl border border-blue-500/30 dark:border-blue-400/30 shadow-xl p-6 flex flex-col justify-between text-left">
                                        <div className="flex flex-col justify-between flex-grow min-w-0 pb-2">
                                            <div>
                                                <h3 
                                                    className="w-full text-base sm:text-lg font-bold text-blue-600 dark:text-blue-400 whitespace-nowrap overflow-hidden text-ellipsis mb-2"
                                                    title={project.title}
                                                    >
                                                    {project.title}
                                                </h3>
                                            ...
                                            <div className="my-auto pt-2">
                                                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Mi Rol:</p>
                                            ...
                                            <div className="pt-2">
                                                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">Tecnologías:</p>
                                                <div className="flex flex-wrap gap-1.5">
                                                    {project.tech.map((t) => (
                                                        <span 
                                                            key={t} 
                                                            className="bg-gray-100 dark:bg-gray-700/80 text-gray-800 dark:text-gray-200 text-xs font-medium px-2.5 py-1 rounded-md border border-gray-200 dark:border-gray-600"
                                                            >
                                                            {t}
                                                        </span>
                                                    ))}
