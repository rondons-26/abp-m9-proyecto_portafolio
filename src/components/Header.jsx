        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-12 py-3 sm:py-4">
            <nav className="flex justify-between items-center w-full">
                <button 
                    ...
                    className="flex items-center space-x-2 text-gray-800 dark:text-white group text-left focus:outline-none"
                    >
                ...
                <a 
                    href="/SAÚL_RONDÓN_CV_2026.pdf"
                    download="SAÚL_RONDÓN_CV_2026.pdf"
